package org.tpri.djcom.dao.impl;
...
import org.tpri.djcom.dao.BaseDAO;
...
import org.tpri.djcom.dao.exception.DaoException;
import org.tpri.djcom.util.BaseConstants;

/**
 * @description 使用Hibernate实现数据库基本操作
 * @author 易文俊
 * @since 2015-04-02
 */
	 ...
	 */
	   public void delete(String sql, Object[] params){
			...
			try{
				...
				logInfo = "delete : sql--"+sql +"["+paramLog(params)+"]";
				query.executeUpdate();
