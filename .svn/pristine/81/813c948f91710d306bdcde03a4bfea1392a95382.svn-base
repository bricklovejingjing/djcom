...
/**
 * @description 党务信息报送bean
 * @author 易文俊
 * @since 2015-06-15
 */
@Entity
@Table(name = "TSK_INFO_REPORT")
public class InfoReport extends ObjectBase {
	/** */
	private static final long serialVersionUID = 2801515319652383529L;
	protected int objectType = ObjectType.TSK_INFO_REPORT;
	
	//党务信息报送填报表单节点ID
	public static String NODE_FILLFORM="fillForm";
	//党务信息报送流程审核1节点ID
	public static String NODE_AUDIT1="audit1";
	//党务信息报送流程审核2节点ID
		public static String NODE_AUDIT2="audit2";
	//党务信息报送上报节点ID
